...
export default function AuthView() {
  ...
  return (
    <div className="w-full min-h-[calc(100vh-80px)] bg-surface py-6 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
      <div className="w-full max-w-[1180px] mx-auto">
        
        {/* Header Superior: Certificaciones y Comunidad */}
        ...
        <div className="relative w-full bg-surface-container-lowest rounded-3xl shadow-[0_20px_60px_-15px_rgba(30,18,74,0.12),0_4px_20px_0_rgba(0,219,235,0.08)] overflow-hidden flex flex-col min-h-[680px]">
          ...
          {/* Tu Componente AuthTabs Reutilizado */}
          <AuthTabs activeTab={activeTab} setActiveTab={setActiveTab} />

          {/* Grid Dual Split */}
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 min-h-[600px]">
            
            {/* LADO IZQUIERDO: Formulario (55% de ancho en Desktop) */}
            ...
            {/* LADO DERECHO: Panel Lateral Decorativo Montessori (45% de ancho en Desktop) */}
        ...
        {/* Footnote de Confianza Inferior */}
