...
export default function Hero() {
  return (
    <section className="relative w-full overflow-hidden px-4 sm:px-6 lg:px-8 py-12 lg:py-20" id="inicio">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        
        {/* Columna Texto */}
        <div className="lg:col-span-7 flex flex-col items-start">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-surface-container-high shadow-sm mb-4">
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
            ...
            <a 
              href="#ubicacion" 
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-surface-container-high text-on-surface font-bold hover:bg-surface-container transition-all text-center"
            >
        ...
        <div className="lg:col-span-5 relative mt-6 lg:mt-0">
          <div className="bg-surface-container-lowest rounded-2xl p-3 shadow-xl">
            <div className="relative w-full h-[300px] sm:h-[380px] rounded-xl overflow-hidden">
              <img 
                ...
                src={kidsHero} 
              />
              <div className="absolute bottom-4 left-4 right-4 bg-white/90 backdrop-blur-md p-3 rounded-xl flex items-center justify-between shadow-md">
